...
namespace Final_Summative
{
    public class Game1 : Game
    {
        ...
        Color colour;
        Vector2 enemyPosition1, enemySpeed1;
        enum Screen
        {
            intro,
            options,
        ...
        protected override void Initialize()
        {
            ...
            enemy = new Enemy(alienTexture, enemyPosition1, enemySpeed1);
        ...
        public class Enemy
        {
            ...
            public Enemy(Texture2D enemyTexture, Vector2 startPosition, Vector2 startVelocity)
            {
